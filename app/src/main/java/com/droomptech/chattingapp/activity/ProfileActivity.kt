...
import com.droomptech.chattingapp.MainActivity
import com.droomptech.chattingapp.databinding.ActivityProfileBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.continueProfile.setOnClickListener {
            if (binding.username.text!!.isEmpty()){
                ...
                Toast.makeText(this, "Plese select your Image", Toast.LENGTH_SHORT).show()
            } else uploadData()
        }
